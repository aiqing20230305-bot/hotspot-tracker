...
INDUSTRY_KEYWORDS_V2 = {
    ...
    "快消": {
        ...
        "产品词": ["洗发水", "牙膏", "洗衣液", "纸巾", "沐浴露", "洗面奶", "卫生巾", "湿巾", "清洁", "洗洁精", "香皂", "护手霜", "身体乳", "护发素", "发膜", "护发精油", "止汗露", "漱口水", "牙线", "棉签", "卸妆棉", "洗脸巾", "洗衣粉", "洗衣凝珠", "柔顺剂", "消毒液", "洁厕剂", "油污净", "玻璃水", "除螨", "驱蚊", "蚊香", "电蚊液", "防晒喷雾", "防晒霜", "隔离霜", "卷纸", "抽纸", "手帕纸", "厨房纸", "湿厕纸", "卫生纸", "棉柔巾"],
        "场景词": ["居家", "家务", "清洁", "收纳", "整理", "好物分享", "好物推荐", "居家好物", "生活小妙招", "家务神器", "清洁神器", "收纳神器", "断舍离", "极简生活", "洗衣", "洗澡", "刷牙", "洗头", "护肤步骤", "日常护理", "家庭清洁", "大扫除"],
        "品牌词": ["宝洁", "联合利华", "蓝月亮", "立白", "威露士", "舒肤佳", "海飞丝", "飘柔", "潘婷", "沙宣", "多芬", "力士", "清扬", "欧乐B", "高露洁", "佳洁士", "云南白药", "黑人", "舒客", "金纺", "奥妙", "汰渍", "碧浪", "滴露", "威猛先生", "超能", "纳爱斯", "雕牌", "七度空间", "护舒宝", "苏菲", "ABC", "高洁丝", "全棉时代", "维达", "清风", "心相印", "洁柔", "得宝"],
        "衍生词": ["除菌", "抑菌", "温和", "敏感肌", "氨基酸", "无硅油", "无添加", "植物配方", "天然成分", "环保", "可降解", "无塑", "零废弃", "极简护肤", "精简护肤", "留香", "持久留香", "深层清洁", "去油", "控油", "保湿", "滋润", "补水", "修护", "柔顺", "去屑", "止痒", "美白", "抗敏", "无香", "低敏"]
    },
    "家电": {
